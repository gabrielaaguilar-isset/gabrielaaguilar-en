...
const works = [
  ...
  },
  {
    ...
    description:
      "Web application developed from scratch using Tailwind CSS, React, and Next.js. All code and functionality were manually implemented to meet the project requirements. The design was provided by a third party, and the implementation was done ensuring seamless integration with the site structure.",
  },
  {
    title: "Travnow",
